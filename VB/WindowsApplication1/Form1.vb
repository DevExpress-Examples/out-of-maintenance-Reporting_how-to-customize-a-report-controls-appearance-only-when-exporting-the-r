...
Namespace WindowsApplication1
	...
	Public Class ExportToExcelCommandHandler
        ...
        Public Sub HandleCommand(command As PrintingSystemCommand, args() As Object, control As IPrintControl, ByRef handled As Boolean) Implements ICommandHandler.HandleCommand
        ...
        Public Function CanHandleCommand(command As PrintingSystemCommand, control As IPrintControl) As Boolean Implements ICommandHandler.CanHandleCommand
